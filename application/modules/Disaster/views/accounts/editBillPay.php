<div class="wraper">      
    ...
    <div class= "row">
        ...
        <div class="col-md-12 container form-wraper" style= "margin-left: 0%;">
            ...
            <form method="POST" id="form" role="form" name="add_form" action="<?php echo site_url("Disaster/updatePayment");?>" onsubmit="return validate()" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name= "memo_no" value= "<?php echo $memo_no; ?>" id= "memo_no" class= "form-control required" readonly>
                    </div>
                        ...
                        <table class= "table table-striped table-bordered table-hover">
                            ...
                            <?php foreach($data as $key){ ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name= "order_no[]" value= "<?php echo $key->order_no; ?>" class="form-control required orderNo" id= "order_no" required>
                                    </td>
                                    ...
                                    <td>
                                        <input type="text" name="pb_amnt[]" value= "<?php echo $key->pb_amount; ?>" class="form-control required pbAmnt" id="pb_amnt" required>
                                    </td>
                                    ...
                                    <td>
                                        <input type="text" name="sb_amnt[]" value= "<?php echo $key->sb_amount; ?>" class="form-control required sbAmnt" id="sb_amnt" required>
                                    </td>
