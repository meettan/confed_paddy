...
<div class="wraper">      
    ...
    <div class="col-md-6 container form-wraper">
        ...
        <form role="form" name="payment_form" method="POST" id="form" action="<?php echo site_url("Disaster/Report/show_dw_billPay");?>" onsubmit="return validate()" >
        
            <div class="form-header">
            
                <h4>Select Collection Date Range</h4>
