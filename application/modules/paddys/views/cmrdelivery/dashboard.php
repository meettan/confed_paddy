    <div class="wraper">      
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
                ...
                <small><a href="<?php echo site_url("paddy/delivery/add");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>
                            ...
                            <tr>
                                ...
                                ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="delivery/edit?trans_no=<?php echo $b_dtls->trans_no; ?>" 
                                                        data-toggle="tooltip"
    ...
    $(document).ready( function (){
        ...
        $('.delete').click(function () {
            ...
            if(result) {
                ...
                window.location = "<?php echo site_url('paddy/delivery/delete?sl_no="+id+"');?>";
