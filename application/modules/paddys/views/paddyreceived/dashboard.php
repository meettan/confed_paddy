    <div class="wraper">      
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Paddy Delivered</strong></h1>
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
                ...
                <small><a href="<?php echo site_url("paddy/received/add");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    foreach($paddyreceived_dtls as $b_dtls) {
                                ...
                                ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="received/edit?trans_no=<?php echo $b_dtls->trans_no; ?>" 
                                                        data-toggle="tooltip"
    ...
    $(document).ready( function (){
        ...
        $('.delete').click(function () {
            ...
            if(result) {
                ...
                window.location = "<?php echo site_url('paddy/received/delete?sl_no="+id+"');?>";
