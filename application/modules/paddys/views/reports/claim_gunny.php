            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align: center; height: 65px; font-size: 12px;">
                        ...
                        <h4>Claim For Usage Charge For Gunny Bags For PAddy</h4>
                    ...
                    <div>
                        ...
                        <p>
                            Claim towards Cost of Usages charges for Gunny Bags for paddy to the F&S
                    ...
                    <table style="width: 100%;">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="text-align: center;" rowspan="2">Quantity of Paddy </br>(Qtl) </th>
                                <th rowspan="2">Number of bag used for paddy </br>(Pcs)</th>
                                <th rowspan="2">Do number & Date</th>
                                <th rowspan="2">Rate of gunny usages for paddy </br>(Rs)</th>
                                <th rowspan="2">Gunny usages claimed for paddy</br>(Rs)</th>
                                <th rowspan="2">Gunny Cut</br>(Rs)</th>
                                <th rowspan="2"> CGST @ 2.5% on Milling Charge</br>(Rs)</th>
                                <th rowspan="2"> SGST @ 2.5% on Milling Charge</br>(Rs)</th>
                                <th rowspan="2">Total Amount Claimed[Rs]</br>(Rs)</th>

                            </tr>
                            <tr>
                                <th >Variety of Rice</th>
                                <th style="text-align: center;">WQSC No. </th>
                                <th>Quantity of CMR </br>(Qtl)</th>                  
                            </tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   ...
                                   <td style="text-align:center;"><?php if($bill_dtls->rice_type=='P'){
                                    ...
                                    <td style="text-align:center;"><?=$bill_dtls->gunny_usege?></td>
                                   <td style="text-align:center;"><?=$bill_dtls->gunny_cut?></td>
                                    <td style="text-align:center;"><?=$bill_dtls->cgst_gunny?></td>
                                   <td style="text-align:center;"><?=$bill_dtls->sgst_gunny?></td>
                                 
                                   <td style="text-align:center;"><?php echo $tot_gunny = ($bill_dtls->gunny_usege)+($bill_dtls->cgst_gunny)+($bill_dtls->sgst_gunny) ?></td>
