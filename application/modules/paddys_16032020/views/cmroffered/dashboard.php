    <div class="wraper">      
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
                ...
                <small><a href="<?php echo site_url("paddy/offered/add");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    foreach($cmroffered_dtls as $b_dtls) {
                                ...
                                ?>
                                                ...
                                                <td><?php echo $b_dtls->tot_offered; ?></td>

                                                <td>
                                
                                                    <a href="offered/edit?trans_no=<?php echo $b_dtls->trans_no; ?>" 
                                                        data-toggle="tooltip"
    ...
    $(document).ready( function (){
        ...
        $('.delete').click(function () {
            ...
            if(result) {
                ...
                window.location = "<?php echo site_url('paddy/offered/delete?sl_no="+id+"');?>";
