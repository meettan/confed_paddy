                ...
                <div id="divToPrint">
                    ...
                    <div style="display: inline; margin: 0;">
                        ...
                        <div style="float:left;  margin-right: 10%; display: inline; margin-bottom: -10px;">
                            ...
                            <?php if(@$bill_dtls->pool_type == 'C'or @$bill_dtls->pool_type == 'S') { 
                                
                               
                           echo "To<br>The Director of Finance,<br>Food & Supplies Department,Govt. of W.B.<br>11 A,MiirzaGhalib Street,Kolkata-700087<br><br>";
                           }  ?>
                    ...
                    <div style="text-align: center; height: 65px; font-size: 12px;">
                         ...
                         P-1, Hide Lane, Akbar Mansion (3 rd Floor), Kolkata-73, Gram: STAFECON 
                        <p>
                            <i class="fa fa-phone" aria-hidden="true"></i> ( 0) 33-2237 7012 /7013,
                            <i class="fa fa-fax" aria-hidden="true"></i> 033-2236 8942,
                            Email Id: confedwb.org@gmail.com, Website: www.confedwb.org.in
                        </p>
                        ...
                        <!-- <p>To<br>
                         ...
                         Food & Supplies Department,Govt. of W.B.<br>
                         11 A,MiirzaGhalib Street,<br>
                         Kolkata-700087</p> -->
                    </div>
                    ...
                    <div>
                    <!-- <h6 style="display: inline;">TTo<br>
                         The Director of Finance,<br>
                         Food & Supplies Department,Govt. of W.B.<br>
                         11 A,MiirzaGhalib Street,<br>
                         Kolkata-700087<br></h6> -->
                        ...
                        <div style="display: inline; box-sizing: border-box; border: 2px solid Black; padding: 6px; width: 65px; border-height: 35px; margin-left: 18%; margin-right: 25%;">
                            ...
                            <strong style="font-size: 14px;">BILL</strong>
                    ...
                    <div>
                        ...
                        <?php if(@$bill_dtls->pool_type == 'S' or @$bill_dtls->pool_type == 'C' ) { ?>
                            Claimed towards the cost of Par Boiled (FAQ) Delivered to the F&S Department.
                            For KMS <?php echo @$bill_dtls->kms_yr; ?>
                            
                        <?php }else {            
                            echo  "Claimed towards the cost of Par Boiled (FAQ) Delivered to the Food Corporation Of India.........................................district.
                            For KMS".@$bill_dtls->kms_yr;
