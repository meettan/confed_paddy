  ...
  public function js_get_mrno() // For JS
        ...
        public function addNewPayment()
        {
            ...
            {   $file_name             = $_POST['file_name'];
                ...
                // $p_bill_round_off  = $_POST['p_bill_round_off'];
                // $p_bill_round_off  = $_POST['p_bill_round_off'];
                $this->StationaryM->addNewbankPayment( $file_name,$page_no,$bank, $ref_no,$tot_s_bill,$tot_p_bill,$s_bill_less_amt,$p_bill_less_amt,$s_bill_add_amt,$p_bill_add_amt,$p_bill_round_off,$s_bill_round_off,$s_bill_add_rnd_off,$p_bill_add_rnd_off, $mr_add_gst,$mr_less_gst,$confed_margin,$margin_add_gst ,$margin_less_gst,$tot_mr_amt);
        ...
        public function updateBillPayment()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=="POST")
            {
                ...
                $s_bill_add_amt      = $_POST['s_bill_add_amt'];
                $p_bill_add_amt      = $_POST['p_bill_add_amt'];
                $s_bill_less_rnd_off  = $_POST['s_bill_less_rnd_off'];
                $p_bill_less_rnd_off  = $_POST['p_bill_less_rnd_off'];
                $s_bill_add_rnd_off  = $_POST['s_bill_add_rnd_off'];
                $p_bill_add_rnd_off  = $_POST['p_bill_add_rnd_off'];
                $mr_add_gst           = $_POST['mr_add_gst'];
                $mr_less_gst          = $_POST['mr_less_gst'];
                ...
                $this->StationaryM->updateNewbankPayment( $file_name,$page_no,$bank, $ref_no,$tot_s_bill,$tot_p_bill,$s_bill_less_amt,$p_bill_less_amt,$s_bill_add_amt,$p_bill_add_amt, $s_bill_less_rnd_off, $p_bill_less_rnd_off,$s_bill_add_rnd_off,$p_bill_add_rnd_off,$mr_add_gst,$tot_mr_amt);
                // echo $this->db->last_query();
                // die();
