...
<div class="wraper">      
    ...
    <div class= "row">
        ...
        <div class="col-md-10 container form-wraper" style= "margin-left: 8%;">
            ...
            <form method="POST" id="form" role="form" name="add_form" action="<?php echo site_url("stationary/updateSBill");?>" onsubmit="return validate()" >
                

                <div class="form-header">
                
                    <h4>Edit Sale Bill</h4>
...
<div class="col-sm-4">
<input type="text" name="pb_no" value= "<?php echo $key1->pb_no; ?>" class="form-control required" id="pb_no" readonly>                 
