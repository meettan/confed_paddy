<div class="wraper">   
    ...
    <div class= "row">
        ...
        <div class="col-md-10 container form-wraper" style= "margin-left: 8%;">
            ...
            <form method="POST" id="form" role="form" name="add_form" action="<?php echo site_url("stationary/addNewSBill");?>" onsubmit="return validate()" >
                ...
                <div class="form-group row">
                    ...
                    <label for="pb_no" class="col-sm-2 col-form-label">PB No<font color= "red">*</font></label>

                    <div class="col-sm-4">

                        <input type="text" name="pb_no" class="form-control required" id="pb_no" required>                    
                        <span id= "alert3"><font color= "red">* Wrong Purchase Bill</font></span>
        ...
        $('#order_no').on( "change", function()
        {
            ...
            .done(function(data)
            {
                if(data)
                {
                    ...
                    var supplierName = JSON.parse(data).name;
                    //console.log(data);                
                    
                    $('#supplier_cd').val(supplierName);
...
<script>
    ...
    $(document).ready(function(){
        ...
        // For gettign total amount after giving nt_amount
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#bill_no').on("change", function(){
            ...
            $.get('<?php echo site_url("stationary/js_get_check_duplicate_saleBillEntry_forDate"); ?>', {bill_no : bill_no, bill_dt : bill_dt})
            .done(function(data){
...
<!-- For checking PBill No -->
<script>

    $(document).ready(function(){

        $('#pb_no').on("change", function(){

            var pb_no = $(this).val();
            var order_no = $('#order_no').val();

            $.get('<?php echo site_url("stationary/js_get_check_PBillNo_forDate") ?>', {pb_no : pb_no, order_no : order_no})
            .done(function(data){
