            ...
            <div class="panel-heading">
                ...
                <div class="item_body">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Bill Collection Details From: <?php echo date("d-m-y",strtotime($startDt)).' To: '.date("d-m-y",strtotime($endDt)) ; ?> </h4>
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/stationary/collectionReport');?>'">Back</button>
