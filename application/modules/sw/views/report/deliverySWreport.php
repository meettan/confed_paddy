        ...
        <div class="col-lg-12 container contant-wraper">
            ...
            <div class="panel-heading">
                ...
                <div class="item_body">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Delivery Details From: <?php echo date("d-m-y",strtotime($start_dt)).' To: '.date("d-m-y",strtotime($end_dt)) ; ?> </h4>
            ...
            <div>
                ...
                <table class="table table-striped" style="width: 100%;">
                    ...
                    <caption><?PHP echo 'Supplier: '.$vendor->vendor_name; ?><hr></caption> 
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/sw/swDeliveryReport');?>'">Back</button>
