            ...
            <div class="panel-heading">
                ...
                <div class="item_body">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Revenew Details From: <?php echo date("d-m-y",strtotime($startDt)).' To: '.date("d-m-y",strtotime($endDt)) ; ?> </h4>
                    ...
                    <?php foreach($total as $key1){ ?>
                        ...
                        <tr>
                            ...
                            <td  style="text-align: center;">
                                <?php echo @$key1->sale_amnt; ?>
                            </td>
                            <td  style="text-align: center;">
                                <?php echo @$key1->purchase_amnt; ?>
                            </td>
                            <td  style="text-align: center;">
                                <?php echo @$key1->shortage; ?>
                            </td>
                            <td  style="text-align: center;">
                                <?php echo @$key1->commission; ?>
                            </td>
                        </tr> 
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/sw/dwRevenew');?>'">Back</button>
