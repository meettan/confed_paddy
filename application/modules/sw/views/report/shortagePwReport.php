            ...
            <div class="panel-heading">
                ...
                <div class="item_body">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Shortage Details For: <?php echo ' Dist: '.$dist->district_name.';  Project: '.$project->cdpo ; ?> </h4>
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" type="button" onclick="location.href='<?php echo base_url('index.php/sw/pwShortageReport');?>'">Back</button>
